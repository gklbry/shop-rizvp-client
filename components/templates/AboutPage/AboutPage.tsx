      ...
      <div className="container">
        ...
        <div className={styles.about__inner}>
          <div className={`${styles.about__info} ${darkModeClass}`}>
            <p>
              Наша команда &quot;ИБ&quot; предлагает Вам заценить этот замечательный сайт и поставить нам зачёт.
            </p>
            <p>
              Ассортимент интернет-магазина включает в
              себя рандомные товары несуществующих брендов на любой вкус! Вперед за покупками!
              Карта для покупок: 5555555555554477. Дата и CVV любые! Enjoy!
            </p>
          </div>
