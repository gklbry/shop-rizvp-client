    ...
    <section className={styles.dashboard}>
      <div className={`container ${styles.dashboard__container}`}>
        ...
        <div className={styles.dashboard__about}>
          ...
          Мы - студенческая команда разработчиков, воплощающая инновации в веб-пространстве. Стремимся к совершенству, объединяем уникальные навыки и творческий подход для создания современных и функциональных сайтов. Ваша идея - наш проект, ваш успех - наша гордость. Добро пожаловать в мир наших веб-решений
          </p>
        </div>
      </div>
    </section>
